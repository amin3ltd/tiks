...
PRETIX_INSTANCE_NAME = config.get('pretix', 'instance_name', fallback='tiks')
...
CSRF_TRUSTED_ORIGINS = [_site_url_parts.scheme + '://' + _site_url_parts.netloc]
...
MAIL_FROM = SERVER_EMAIL = DEFAULT_FROM_EMAIL = config.get('mail', 'from', fallback='tiks@localhost')

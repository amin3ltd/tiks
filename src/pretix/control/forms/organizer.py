...
class OrganizerForm(I18nModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['name'].help_text = _('People will see this name.')
        self.fields['name'].widget.attrs.setdefault('placeholder', _('e.g. Addis Events'))
        self.fields['slug'].help_text = _('Used in links. Keep it short and easy to share.')
        self.fields['slug'].widget.attrs.setdefault('placeholder', _('e.g. addis-events'))

...
class RandomTicketSecretGenerator(BaseTicketSecretGenerator):
    verbose_name = _('Random (default, works with all tiks apps)')
    identifier = 'random'
...
class Sig1TicketSecretGenerator(BaseTicketSecretGenerator):
    ...
    """
    verbose_name = _('tiks signature scheme 1 (for very large events, changes semantics of offline scanning – '

...
DEFAULTS = {
    ...
    'attendee_emails_asked': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_("Normally, tiks asks for one email address per order and the order confirmation will be sent "
    ...
    'tax_rounding': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_(
                "Note that if you transfer your sales data from tiks to an external system for tax reporting, you "
    ...
    'region': {
        ...
        'form_kwargs': lambda: dict(
            label=_('Country'),
            help_text=_('Used for dates, phone numbers, and address forms. Ethiopia is selected by default.'),
            **country_choice_kwargs()
        ),
    },
...
Your {organizer} team"""))  # noqa: W291
    ...
    'favicon': {
        ...
        'form_kwargs': dict(
            ...
            help_text=_('If you provide a favicon, we will show it instead of the default tiks icon. '
    ...
    'checkout_phone_helptext': {
        'default': LazyI18nString.from_gettext(gettext_noop(
            'Use a phone number we can reach in Ethiopia. The +251 country code is selected automatically.'
        )),
        'type': LazyI18nString,
        'serializer_class': I18nField,
        'form_class': I18nFormField,

...
on pretix.eu, this event is available by default at ``https://tiks.cc/bigorg/awesomecon/``
and the admin panel is available at ``https://tiks.cc/control/event/bigorg/awesomecon/``.
...
``https://tiks.cc/bigorg/awesomecon/`` contains two parameters of nearly arbitrary content

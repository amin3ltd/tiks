...
.. http:post:: /api/v1/organizers/(organizer)/events/(event)/offlinesalesbatches/
   ...
   **Example response**:
   ...
   .. sourcecode:: http
      ...
      {
        "check": "https://tiks.cc/api/v1/organizers/bigevents/events/sampleconf/offlinesalesbatches/check/29891ede-196f-4942-9e26-d055a36e98b8/"
      }
...
.. http:post:: /api/v1/organizers/(organizer)/events/(event)/offlinesalesbatches/(id)/render/
   ...
   **Example response**:
   ...
   .. sourcecode:: http
      ...
      {
        "download": "https://tiks.cc/api/v1/organizers/bigevents/events/sampleconf/offlinesalesbatches/1/download/29891ede-196f-4942-9e26-d055a36e98b8/3f279f13-c198-4137-b49b-9b360ce9fcce/"
      }
